      ...
      <div className="flex min-h-screen w-full flex-col px-6 py-10 sm:px-10 lg:w-1/2 lg:px-14 xl:px-20">
        ...
        <div className="mx-auto flex w-full max-w-[470px] flex-1 flex-col justify-center pb-16">
          <div className="mb-10 text-center">
            <h1 className="text-5xl font-extrabold tracking-tight text-black">Join Linktree</h1>
            <p className="mt-4 text-2xl text-zinc-600">Sign up for free!</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <ActionButton loading={isPending} onClick={handleSignup} label="Continue" />
          </div>

          <p className="mt-10 text-center text-base leading-7 text-zinc-600">
            By clicking <span className="font-semibold text-zinc-700">Create account</span>, you agree
